...
if edgeStruct.useMex
    [nodeBel,edgeBel,logZ] = UGM_Infer_MFC(nodePot,edgePot,int32(edgeStruct.edgeEnds),int32(edgeStruct.nStates),int32(edgeStruct.V),int32(edgeStruct.E),int32(edgeStruct.maxIter));
else
