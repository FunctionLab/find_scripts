function  [currentSamples,nodeBel,edgeBel,logZ] = maxent_Infer_Sample_clamp_batch_newpar(wnode, wedge, edgeStruct,currentSamples,clamp)
...
%   end
currentSamples = UGM_Sample_GibbsC_Clamp_Single_Batch_OpenMP_edgePot(nodePot,edgePot,edgeEnds,nStates,V,E,maxIter,int32(0),int32(currentSamples),int32(clamp),int32(75));
currentSamples=double(currentSamples-1);

clamped=currentSamples(clamp);
