function [NLL,g] = UGM_MRF_NLL_Chromatin(w,nInstances,suffStat,nodeMap,edgeMap,edgeStruct,inferFunc,varargin)
...
% Make potentials
% ["Local nodes"; "Global nodes"], ["Local edges"; "Global Edges"] 
