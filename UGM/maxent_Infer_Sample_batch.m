function  [currentSamples,nodeBel,edgeBel,logZ] = maxent_Infer_Sample_batch(nodePot, edgePot, edgeStruct,currentSamples)
...
%end
currentSamples = UGM_Sample_GibbsC_Single_Batch_edgePot(nodePot,edgePot,edgeEnds,nStates,V,E,maxIter,int32(0),int32(currentSamples),int32(75));

% Comment the above for loop and use this one below if you can compile it with openmp
%     currentSamples = UGM_Sample_GibbsC_Single_Batch_OpenMP_edgePot(nodePot,edgePot,edgeEnds,nStates,V,E,maxIter,int32(0),int32(currentSamples),int32(75));
