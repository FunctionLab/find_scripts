function  [currentSamples,currentSamplesprob,nodeBel,edgeBel,logZ] = maxent_Infer_Sample_batch_withprob(nodePot, edgePot, edgeStruct,currentSamples)
...
%   end
     [currentSamples,currentSamplesprob] = UGM_Sample_GibbsC_Single_Batch_OpenMP_edgePot_withprob(nodePot,edgePot,edgeEnds,nStates,V,E,maxIter,int32(0),int32(currentSamples),int32(75));
