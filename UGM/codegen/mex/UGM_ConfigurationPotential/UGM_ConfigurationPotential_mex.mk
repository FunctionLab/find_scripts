...
MAKEFILE = UGM_ConfigurationPotential_mex.mk

include UGM_ConfigurationPotential_mex.mki


SRC_FILES =  \
	UGM_ConfigurationPotential.c \
	UGM_ConfigurationPotential_initialize.c \
	UGM_ConfigurationPotential_terminate.c \
	UGM_ConfigurationPotential_api.c \
	UGM_ConfigurationPotential_mex.c

MEX_FILE_NAME_WO_EXT = UGM_ConfigurationPotential_mex
...
SYS_INCLUDE += /I "E:\Code\MATLAB~1\UGM\codegen\mex\UGM_CO~1"
SYS_INCLUDE += /I "E:\Code\MATLAB~1\UGM\sub"
...
%.$(OBJEXT) : E:\Code\MATLAB~1\UGM\codegen\mex\UGM_CO~1/%.c
	$(CC) $(CFLAGS) "$<"



%.$(OBJEXT) : E:\Code\MATLAB~1\UGM\codegen\mex\UGM_CO~1/%.cpp
	$(CC) $(CPPFLAGS) "$<"
